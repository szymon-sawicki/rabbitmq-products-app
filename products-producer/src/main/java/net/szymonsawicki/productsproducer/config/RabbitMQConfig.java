...
public class RabbitMQConfig {
    ...
    Binding bindingHeaderExpensiveClothings() {
        ...
        return BindingBuilder.bind(qExpensiveClothings()).to(xProductsHeader()).whereAll(headers).match();
    }
    ...
    public Declarables createDeadLetterSchema() {
        return new Declarables(
                ...
                new Binding("q.fall-back-products", Binding.DestinationType.QUEUE, "x.warehouse-failures", "fall-back", null)
        );
    }
}
